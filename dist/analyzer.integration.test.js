 ...
 */
function createMockFrame(frameIndex, fps = 30, width = 640, height = 480) {
 ...
 */
function createMockFrameProvider(frameCount, fps = 30, width = 640, height = 480) {
    let currentIndex = 0;
    return {
        getNextFrame: async () => {
 ...
 */
function createLiveStreamFrameProvider(frameCount, fps = 30) {
    let currentIndex = 0;
    return {
        getNextFrame: async () => {
            if (currentIndex >= frameCount) {
...
//# sourceMappingURL=analyzer.integration.test.js.map