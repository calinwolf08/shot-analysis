...
import { ShootingElbowFlareCalculator, ShootingElbowAngleCalculator, MaxArmExtensionCalculator, WristSnapAngleCalculator, FollowThroughHoldCalculator, } from "./shooting-arm";
 ...
 */
function createShootingPose(frameIndex, options = {}) {
    const { 
    // Default shooting arm positions for right-handed shooter
    shoulderX = 0.6, shoulderY = 0.3, shoulderZ = 0, elbowX = 0.65, elbowY = 0.45, elbowZ = 0, wristX = 0.7, wristY = 0.25, wristZ = 0, shoulderVisibility = 1.0, elbowVisibility = 1.0, wristVisibility = 1.0, 
    // Hip positions
    leftHipX = 0.45, leftHipY = 0.6, leftHipZ = 0, rightHipX = 0.55, rightHipY = 0.6, rightHipZ = 0, 
    // Guide shoulder (left for right-handed)
    guideShoulderX = 0.4, guideShoulderY = 0.3, guideShoulderZ = 0, 
    // Index finger
    indexX = 0.72, indexY = 0.22, indexZ = 0, } = options;
...
describe("FollowThroughHoldCalculator", () => {
    ...
    describe("basic functionality", () => {
        ...
        it("returns 0 when follow-through not held", () => {
            ...
            const poseLandmarks = Array.from({ length: 5 }, (_, i) => createShootingPose(i, {
                shoulderX: 0.5,
                shoulderY: 0.3,
                elbowX: 0.55,
...
//# sourceMappingURL=shooting-arm.test.js.map