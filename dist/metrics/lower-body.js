 ...
 */
function getShoulderWidth(leftShoulder, rightShoulder) {
 ...
 */
export class HipDropCalculator {
    name = "hipDrop";
    description = "How far hips drop in load phase (normalized to shoulder width)";
    unit = "ratio";
    calculate(context) {
 ...
 */
export class KneeFlexionCalculator {
    name = "kneeFlexion";
    description = "Maximum knee bend angle at load phase (degrees, 180 = straight)";
    unit = "degrees";
    calculate(context) {
        ...
        for (let frameIndex = loadPhase.startFrame; frameIndex <= loadPhase.endFrame; frameIndex++) {
            ...
            foundValidFrame = true;
            const avgAngle = getAverageKneeAngle(leftHip, leftKnee, leftAnkle, rightHip, rightKnee, rightAnkle);
 ...
 */
export class LegExtensionStartCalculator {
    name = "legExtensionStart";
 ...
 */
export function createLowerBodyCalculators() {
    return [
...
//# sourceMappingURL=lower-body.js.map