...
import { BackPostureCalculator, HeadTiltCalculator, ShoulderAlignmentCalculator, HandCupVsHingeCalculator, } from "./posture";
 ...
 */
function createPosturePose(frameIndex, options = {}) {
    const { 
    // Default upright posture - shoulders centered above hips
    leftShoulderX = 0.45, leftShoulderY = 0.3, leftShoulderZ = 0, rightShoulderX = 0.55, rightShoulderY = 0.3, rightShoulderZ = 0, leftHipX = 0.45, leftHipY = 0.6, leftHipZ = 0, rightHipX = 0.55, rightHipY = 0.6, rightHipZ = 0, 
    // Eyes at same height (no tilt)
    leftEyeX = 0.47, leftEyeY = 0.15, leftEyeZ = 0, rightEyeX = 0.53, rightEyeY = 0.15, rightEyeZ = 0, 
    // Ears at same height
    leftEarX = 0.43, leftEarY = 0.17, leftEarZ = 0, rightEarX = 0.57, rightEarY = 0.17, rightEarZ = 0, 
    // Nose centered
    noseX = 0.5, noseY = 0.12, noseZ = 0, 
    // Default wrist positions (shooting hand)
    rightWristX = 0.6, rightWristY = 0.25, rightWristZ = 0, leftWristX = 0.4, leftWristY = 0.35, leftWristZ = 0, 
    // Index fingers
    rightIndexX = 0.62, rightIndexY = 0.22, rightIndexZ = 0, leftIndexX = 0.38, leftIndexY = 0.32, leftIndexZ = 0, 
    // Elbows
    rightElbowX = 0.58, rightElbowY = 0.4, rightElbowZ = 0, leftElbowX = 0.42, leftElbowY = 0.4, leftElbowZ = 0, 
    // Visibility defaults
    shoulderVisibility = 1.0, hipVisibility = 1.0, eyeVisibility = 1.0, earVisibility = 1.0, wristVisibility = 1.0, } = options;
...
describe("HeadTiltCalculator", () => {
    ...
    describe("basic functionality", () => {
        ...
        it("calculates 0 degrees for level head", () => {
            ...
            expect(Math.abs(result.value?.value)).toBeLessThan(5);
        });
        it("calculates positive angle for head tilted right", () => {
            ...
            const tiltValue = result.value?.value;
...
describe("ShoulderAlignmentCalculator", () => {
    ...
    describe("basic functionality", () => {
        ...
        it("calculates angle for rotated shoulders", () => {
            ...
            expect(Math.abs(result.value?.value)).toBeGreaterThan(0);
        });
...
//# sourceMappingURL=posture.test.js.map