 ...
 */
function createRealisticLandmarks(wristY, hipY = 0.55, kneeAngleFactor = 1) {
    const landmarks = [];
 ...
 */
function createRealisticShotSequence() {
    const frames = [];
 ...
 */
function createQuickReleaseShotSequence() {
    const frames = [];
 ...
 */
function createTwoShotsSequence() {
...
//# sourceMappingURL=integrated-shot-detector.integration.test.js.map