...
import { ShotPhase, SHOT_PHASES, TOTAL_SHOT_PHASES, createEmptyPhaseRange, createEmptyShot, createNoShotFrameLabel, hasPhase, getPhaseDuration, getShotDuration, } from "./types";
describe("ShotPhase enum", () => {
    ...
    describe("SHOT_PHASES constant", () => {
        ...
        it("is readonly", () => {
            expectTypeOf(SHOT_PHASES).toEqualTypeOf();
        });
    });
...
describe("Shot type", () => {
    describe("structure", () => {
        ...
        it("allows optional boundaries", () => {
            const shotWithoutBoundaries = {
                shotIndex: 0,
                frameRange: { start: 0, end: 50 },
                phases: {},
            };
            const shotWithBoundaries = {
                shotIndex: 0,
                frameRange: { start: 0, end: 50 },
                phases: {},
                boundaries: [
        ...
        it("allows optional confidence", () => {
            const shotWithoutConfidence = {
                shotIndex: 0,
                frameRange: { start: 0, end: 50 },
                phases: {},
            };
            const shotWithConfidence = {
                shotIndex: 0,
                frameRange: { start: 0, end: 50 },
                phases: {},
                confidence: 0.92,
