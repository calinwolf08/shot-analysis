 ...
 */
export function detectShotStart(analyses, config) {
    const startFrames = [];
 ...
 */
export function detectShotEnd(analyses, startFrame, config) {
 ...
 * ```
 */
export function detectShots(poseData, config = {}) {
 ...
 */
export function createPoseShotDetector(config = {}) {
    return (poseData) => detectShots(poseData, config);
}
//# sourceMappingURL=pose-shot-detector.js.map