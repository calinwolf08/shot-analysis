 ...
 */
export function sanitizeVideoName(videoName) {
    return videoName
...
describe("sanitizeVideoName", () => {
    ...
    describe("case conversion", () => {
        ...
        it("converts mixed case to lowercase", () => {
            expect(sanitizeVideoName("Basketball Shot Analysis.mp4")).toBe("basketball-shot-analysis");
        });
    });
    describe("combined transformations", () => {
        it("handles complex filename", () => {
            expect(sanitizeVideoName("My Shot (Copy 2) - Final.mov")).toBe("my-shot-copy-2---final");
        });
        ...
        it("handles real-world example: basketball video", () => {
            expect(sanitizeVideoName("Basketball Free Throw Practice.mp4")).toBe("basketball-free-throw-practice");
        });
        ...
        it("handles real-world example: screen recording", () => {
            expect(sanitizeVideoName("Screen Recording 2024-01-15 at 3.45.23 PM.mov")).toBe("screen-recording-2024-01-15-at-34523-pm");
        });
    });
    describe("edge cases", () => {
