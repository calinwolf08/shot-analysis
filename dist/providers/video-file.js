 ...
 * ```
 */
export class VideoFileProvider {
    metadata;
    fps;
    frames;
    currentFrameIndex = 0;
     ...
     */
    constructor(metadata, fps, frames) {
     ...
     */
    static createWithMockData(options) {
     ...
     */
    static async extractVideoData(filePath) {
 ...
 * ```
 */
export async function createVideoFileProvider(filePath) {
