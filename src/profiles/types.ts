 ...
 */
export function createEmptyProfileComparison(
  profileName: string,
): ProfileComparison {
  return {
    profile: profileName,
 ...
 */
export function isNumericTarget(
  target: MetricTarget,
): target is MetricTarget & { readonly acceptable: NumericRange } {
  return (
 ...
 */
export function isCategoricalTarget(
  target: MetricTarget,
): target is MetricTarget & { readonly acceptable: readonly string[] } {
