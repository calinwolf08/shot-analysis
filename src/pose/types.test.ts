...
describe("Landmark type", () => {
  describe("structure", () => {
    ...
    it("enforces readonly properties at type level", () => {
      expectTypeOf<Landmark["x"]>().toEqualTypeOf<number>();
      expectTypeOf<Landmark["y"]>().toEqualTypeOf<number>();
      expectTypeOf<Landmark["z"]>().toEqualTypeOf<number>();
      expectTypeOf<Landmark["visibility"]>().toEqualTypeOf<number>();
      expectTypeOf<Landmark["confidence"]>().toEqualTypeOf<number>();
    });
  });
...
describe("PoseLandmarks type", () => {
  describe("structure", () => {
    ...
    it("enforces readonly landmarks array at type level", () => {
      expectTypeOf<PoseLandmarks["landmarks"]>().toEqualTypeOf<
        readonly Landmark[]
      >();
      expectTypeOf<PoseLandmarks["poseConfidence"]>().toEqualTypeOf<number>();
    });
  });
...
describe("PoseDetectionResult type", () => {
  ...
  it("can be null for no pose detected", () => {
    const result: PoseDetectionResult = null;
...
describe("LANDMARK_INDEX", () => {
  ...
  describe("type safety", () => {
    it("LandmarkIndexValue is a union of 0-32", () => {
      const validIndex: LandmarkIndexValue = 0;
      const anotherValidIndex: LandmarkIndexValue = 32;
    ...
    it("LandmarkName includes all landmark names", () => {
      const validName: LandmarkName = "NOSE";
      const anotherValidName: LandmarkName = "RIGHT_FOOT_INDEX";
...
describe("getLandmarkByIndex", () => {
  const createTestPoseLandmarks = (): PoseLandmarks => {
  ...
  it("returns the landmark at the specified index", () => {
    ...
    const shoulder = getLandmarkByIndex(
      poseLandmarks,
  ...
  it("returns undefined for negative index", () => {
    ...
    const result = getLandmarkByIndex(poseLandmarks, -1 as LandmarkIndexValue);
  ...
  it("returns undefined for index >= 33", () => {
    const poseLandmarks = createTestPoseLandmarks();
    const result = getLandmarkByIndex(poseLandmarks, 33 as LandmarkIndexValue);
  ...
  it("returns last landmark for index 32", () => {
    const poseLandmarks = createTestPoseLandmarks();
    const footIndex = getLandmarkByIndex(
      poseLandmarks,
...
describe("createEmptyLandmark", () => {
  ...
  it("returns a valid Landmark type", () => {
    const empty = createEmptyLandmark();
    expectTypeOf(empty).toEqualTypeOf<Landmark>();
  });
});
...
describe("createEmptyPoseLandmarks", () => {
  ...
  it("returns a valid PoseLandmarks type", () => {
    const empty = createEmptyPoseLandmarks();
    expectTypeOf(empty).toEqualTypeOf<PoseLandmarks>();
  });
});
