...
describe("Pose Detector Factory", () => {
  ...
  describe("UnknownRuntimeError", () => {
    it("extends Error", () => {
      const error = new UnknownRuntimeError("invalid" as PoseDetectorRuntime);
    ...
    it("provides descriptive error message", () => {
      const error = new UnknownRuntimeError("unknown" as PoseDetectorRuntime);
  ...
  describe("configuration passthrough", () => {
    it("passes modelPath to node detector", async () => {
      ...
      expect(mockCreateNodeDetector).toHaveBeenCalledWith(
    ...
    it("passes modelPath to browser detector", async () => {
      ...
      expect(mockCreateBrowserDetector).toHaveBeenCalledWith(
        expect.objectContaining({
          modelPath: "/custom/model.task",
        }),
      );
  ...
  describe("initialization errors", () => {
    it("propagates errors from node detector creation", async () => {
      ...
      await expect(createPoseDetector({ runtime: "node" })).rejects.toThrow(
    ...
    it("propagates errors from browser detector creation", async () => {
      ...
      await expect(createPoseDetector({ runtime: "browser" })).rejects.toThrow(
