 ...
 */
export type LandmarkIndexValue =
  (typeof LANDMARK_INDEX)[keyof typeof LANDMARK_INDEX];
 ...
 */
export function createEmptyLandmark(): Landmark {
  return {
    x: 0,
    y: 0,
    z: 0,
 ...
 */
export function createEmptyPoseLandmarks(): PoseLandmarks {
  return {
    landmarks: Array.from({ length: TOTAL_LANDMARKS }, () =>
      createEmptyLandmark(),
    ),
    poseConfidence: 0,
  };
 ...
 */
export function isLandmarkOccluded(
  landmark: Landmark,
