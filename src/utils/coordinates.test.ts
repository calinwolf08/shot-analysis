...
describe("normalizeToBodyScale", () => {
  ...
  describe("edge cases", () => {
    it("throws error when shoulder width is zero", () => {
      ...
      expect(() => normalizeToBodyScale(distance, shoulderWidth)).toThrow(
...
describe("calculateRelativePosition", () => {
  describe("basic relative position", () => {
    it("calculates position relative to reference point at origin", () => {
      ...
      const reference: Point3D = { x: 0, y: 0, z: 0 };
    ...
    it("calculates position relative to non-origin reference", () => {
      const point: Point3D = { x: 5, y: 7, z: 9 };
      const reference: Point3D = { x: 2, y: 3, z: 4 };
    ...
    it("returns zero vector when point equals reference", () => {
      ...
      const reference: Point3D = { x: 5, y: 5, z: 5 };
  ...
  describe("negative coordinates", () => {
    ...
    it("handles reference with negative coordinates", () => {
      const point: Point3D = { x: 1, y: 2, z: 3 };
      const reference: Point3D = { x: -1, y: -2, z: -3 };
    ...
    it("handles both with negative coordinates", () => {
      const point: Point3D = { x: -3, y: -5, z: -7 };
      const reference: Point3D = { x: -1, y: -2, z: -3 };
  ...
  describe("edge cases", () => {
    it("handles very small coordinate differences", () => {
      const point: Point3D = { x: 0.0001, y: 0.0002, z: 0.0003 };
      const reference: Point3D = { x: 0, y: 0, z: 0 };
    ...
    it("handles very large coordinates", () => {
      const point: Point3D = { x: 1000001, y: 1000002, z: 1000003 };
      const reference: Point3D = { x: 1000000, y: 1000000, z: 1000000 };
  ...
  describe("biomechanics context", () => {
    it("calculates wrist position relative to head", () => {
      ...
      const wrist: Point3D = { x: 0.6, y: 0.3, z: 0.1 };
      const head: Point3D = { x: 0.5, y: 0.8, z: 0 };
    ...
    it("calculates elbow position relative to shoulder", () => {
      const elbow: Point3D = { x: 0.3, y: 0.5, z: 0.1 };
      const shoulder: Point3D = { x: 0.2, y: 0.6, z: 0 };
