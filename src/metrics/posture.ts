 ...
 */
function angleBetweenVectors(v1: Point3D, v2: Point3D): number {
 ...
 */
function calculateAngle(a: Point3D, vertex: Point3D, c: Point3D): number {
  const va = {
    x: a.x - vertex.x,
    y: a.y - vertex.y,
    z: a.z - vertex.z,
 ...
 */
export class BackPostureCalculator implements MetricCalculator {
 ...
 */
export class HeadTiltCalculator implements MetricCalculator {
 ...
 */
export class ShoulderAlignmentCalculator implements MetricCalculator {
 ...
 * - Neutral: in between
 */
export class HandCupVsHingeCalculator implements MetricCalculator {
  ...
  calculate(context: MetricCalculatorContext): MetricCalculatorResult {
    ...
    let category: HandPositionCategory;
 ...
 */
export function createPostureCalculators(): readonly MetricCalculator[] {
  return [
