 ...
 */
export function createEmptyMetricValue(frame: number = 0): MetricValue {
  return {
    value: 0,
    unit: "",
    frame,
 ...
 */
export function createEmptyShotAnalysis(shotIndex: number = 0): ShotAnalysis {
  return {
    shotIndex,
 ...
 * Useful for initialization or testing.
 */
export function createEmptyVideoMetadata(): VideoMetadata {
  return {
    width: 0,
    height: 0,
    fps: 0,
 ...
 */
export function isSuccessfulMetricResult(
  result: MetricCalculatorResult,
): result is MetricCalculatorResult & { readonly value: MetricValue } {
 ...
 */
export function getAverageMetricConfidence(analysis: ShotAnalysis): number {
 ...
 */
export function filterMetricsByConfidence(
