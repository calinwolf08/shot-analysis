 ...
 */
function createGuideArmPose(
  frameIndex: number,
  options: {
    // Guide arm positions (left side for right-handed shooter)
    ...
    guideWristY?: number;
    guideWristZ?: number;
    // Guide hand index finger
    guideIndexX?: number;
    guideIndexY?: number;
    guideIndexZ?: number;
    // Shooting arm positions (right side for right-handed shooter)
    shootingShoulderX?: number;
    shootingShoulderY?: number;
    shootingShoulderZ?: number;
    shootingWristX?: number;
    shootingWristY?: number;
    shootingWristZ?: number;
    // Shooting hand index finger
    shootingIndexX?: number;
    shootingIndexY?: number;
    shootingIndexZ?: number;
    // Hip positions
    leftHipX?: number;
    leftHipY?: number;
    leftHipZ?: number;
    ...
    rightHipZ?: number;
    // Visibility
    guideShoulderVisibility?: number;
    guideElbowVisibility?: number;
    guideWristVisibility?: number;
    guideIndexVisibility?: number;
    shootingIndexVisibility?: number;
  } = {},
): PoseLandmarks {
  const {
    ...
    shootingShoulderX = 0.6,
    shootingShoulderY = 0.3,
    shootingShoulderZ = 0,
    shootingWristX = 0.55,
    shootingWristY = 0.28,
    shootingWristZ = 0,
    ...
    rightHipZ = 0,
    // Visibility
    guideShoulderVisibility = 1.0,
    guideElbowVisibility = 1.0,
    guideWristVisibility = 1.0,
    guideIndexVisibility = 1.0,
    shootingIndexVisibility = 1.0,
  } = options;
...
describe("GuideHandPositionCalculator", () => {
  ...
  describe("basic functionality", () => {
    ...
    it("returns categorical value", () => {
      ...
      expect(["side", "under", "front", "thumb-up"]).toContain(
        result.value?.value,
      );
    });
  });
