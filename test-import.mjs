...
console.log(
  `   LANDMARK_INDICES keys: ${Object.keys(LANDMARK_INDICES).length}`,
);
...
const distance = calculateDistance({ x: 0, y: 0, z: 0 }, { x: 3, y: 4, z: 0 });
console.log(`   calculateDistance (5): ${distance.toFixed(1)}`);

// Test 6: ShotAnalyzer class exists
console.log("\n6. Testing ShotAnalyzer:");
console.log(
  `   ShotAnalyzer is a class: ${typeof ShotAnalyzer === "function"}`,
);
console.log(
  `   createShotAnalyzer is a function: ${typeof createShotAnalyzer === "function"}`,
);

// Test 7: Provider classes exist
console.log("\n7. Testing providers:");
console.log(
  `   VideoFileProvider is a class: ${typeof VideoFileProvider === "function"}`,
);
console.log(
  `   MediaStreamProvider is a class: ${typeof MediaStreamProvider === "function"}`,
);
console.log(
  `   createVideoFileProvider is a function: ${typeof createVideoFileProvider === "function"}`,
);
console.log(
  `   createMediaStreamProvider is a function: ${typeof createMediaStreamProvider === "function"}`,
);

// Test 8: ProfileComparisonEngine
console.log("\n8. Testing ProfileComparisonEngine:");
console.log(
  `   ProfileComparisonEngine is a class: ${typeof ProfileComparisonEngine === "function"}`,
);
